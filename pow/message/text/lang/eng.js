...
exports.wrongFormat = () => {
    return `Formato incorrecto! Por favor checa su uso en *${prefix}menu*.`
}
...
exports.ownerOnly = () => {
    return `Este comando solo lo puede usar el Administrador!`
}
...
exports.groupOnly = () => {
    return `Este comando solo se puede usar en un grupo!`
}

exports.adminOnly = () => {
    return `Este comando solo puede ser usado por administradores de grupo!`
}

exports.notNsfw = () => {
    return `NSFW no esta habilitado!`
}
...
exports.addedGroup = (chat) => {
    return `Gracias por invitarme *${chat.contact.name}*!\n\nPor favor registrate tecleando:\n*${prefix}register* nombre | edad`
}
...
exports.listBlock = (blockNumber) => {
    return `------[ BLOQUEADOS ]------\n\nTotal bloqueados: *${blockNumber.length}* usuarios(s)\n`
}
...
exports.notRegistered = () => {
    return `Aun no estas registrad@ en nuestra base de datos!\n\nRegistrate tecleando:\n*${prefix}register* nombre | edad`
}

exports.registered = (name, age, userId, time, serial) => {
    return `*「 REGISTRATION 」*\n\nTu cuenta fue registrada correctamente:\n\n➸ *Nombre*: ${name}\n➸ *Edad*: ${age}\n➸ *ID*: ${userId}\n➸ *Fecha registro*: ${time}\n➸ *Serial*: ${serial}\n\nNote:\nNO compartas tu *serial* a nadie!\n\nNo olvides leer las reglas tecleando: *${prefix}rules* .`
}
...
exports.videoLimit = () => {
    return `El tamaño del video es muy grande!`
}
...
exports.welcomeOn = () => {
    return `Opcion de Bienvenida, *activada*!`
}

exports.welcomeOff = () => {
    return `Opcion de bienvenida, *desactivada*!`
}
...
exports.autoStikOn = () => {
    return `Auto-sticker *activado*!`
}

exports.autoStikOff = () => {
    return `Auto-sticker *desactivado*!`
}

exports.autoStikOnAlready = () => {
    return `Auto-sticker ya esta activado.`
}
...
exports.pc = (pushname) => {
    return `*「 REGISTRATION 」*\n\nTu cuenta fue registrada exitosamente! Por favor checa mi mensaje privado ${pushname}~ :3`
}
...
exports.pcOnly = () => {
    return `Este comando solo puede ser usado en mi privado!`
}
...
Teclea *${prefix}menu* numero para abrir la pagina de ese menu.

Nota:
No abuses del bot.
Este bot tienen una proteccion de *5 segundos*.
...
Este bot actualmente es desarrollado por Queen & Power 
visitanos:
